...
<header>
    <div class="row">
        ...
        <div class="col-sm-6 text-right h2"> <a class="btn btn-primary" href="customers/add.php"><i class="fa fa-plus"></i> Novo Cliente</a> <a class="btn btn-default" href="index.php"><i class="fa fa-refresh"></i> Atualizar</a> </div>
    </div>
</header>
...
<table class="table table-hover">
    ...
    <tbody> <?php if ($customers) : ?> <?php foreach ($customers as $customer) : ?> <tr>
                    ...
                    <td class="actions text-right">
                        <a href="/customers/view.php?id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Visualizar</a>
                        <a href="/customers/edit.php?id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i> Editar</a>
